...
$(document).ready(function(){
  ...
  submitHandler = function(event){
    ...
    if (Stripe){
      ...
      show_errors("Faild to load credit card processing functionality. Please reload the page");
    }
    return false;
  };
  ...
  // handle event of dropdown changing
  ...
  // Set up plan change event listener for #tenant_plan id in the forms class cc_form 
  ...
  // function to handle the token received from Stripe and remove from credit card fields
